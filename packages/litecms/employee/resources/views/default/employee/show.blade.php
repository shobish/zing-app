...
<div class="app-entry-form-wrap">
        ...
        <div class="actions">
            <div class="action-buttons">
                <button type="button" class="btn btn-with-icon btn-link" data-action='EDIT' data-load-to="#app-entry"
                    data-url="{!!guard_url('employee/employee')!!}/{!!$data->getRouteKey()!!}/edit"><i
                ...
                <button type="button" class="btn btn-with-icon btn-link" data-action='DELETE' data-load-to="#app-entry"
                    data-list="#item-list" data-url="{!!guard_url('employee/employee')!!}/{!!$data->getRouteKey()!!}"><i
    ...
    ->class('app-form-show')
    ->method('PUT')
    ->action(guard_url('employee/employee'. $data->getRouteKey()))!!}

    @include('employee::employee.entry', ['mode' => 'show'])

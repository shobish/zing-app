...
<div class="app-item">
    <div class="app-avatar">
        ...
        <div class="app-avatar-checkbox">
            <input type="checkbox" name="item_list[]" id="item_{!!$value->getRouteKey()!!}" value="{!!$value->getRouteKey()!!}">
            <label for="item_{!!$value->getRouteKey()!!}"></label>
        </div>
    </div>
    <div class="app-info" data-action='SHOW' data-load-to="#app-entry"
        data-url="{!!guard_url('employee/employee')!!}/{!!$value->getRouteKey()!!}">
        <h3>{!!@$value['title']!!}</h3>
        <div class="app-metas">
            <p>{!!@$value['details']!!}</p>
    ...
    <div class="app-actions">
        <a href="{!!guard_url('employee/employee')!!}/{!!$value->getRouteKey()!!}" class="btn fas fa-pencil-alt" data-action='EDIT'
            data-load-to="#app-entry" data-url="{!!guard_url('employee/employee')!!}/{!!$value->getRouteKey()!!}/edit"></a>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item" href="{!!guard_url('employee/employee')!!}/{!!$value->getRouteKey()!!}" 
                                        data-action='DELETE' data-load-to="#app-entry" data-list="#item-list"
                                        data-url="{!!guard_url('employee/employee')!!}/{!!$value->getRouteKey()!!}"><i class="las la-times text-danger"></i>Delete</a>
            </div>
        </div>
    </div>
</div>

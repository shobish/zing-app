...
<div class="app-entry-form-wrap">
        ...
        <div class="actions">
            <div class="action-buttons">
                <button type="button" class="btn btn-with-icon btn-link" data-action='EDIT' data-load-to="#app-entry"
                    data-url="{!!guard_url('employee/employe')!!}/{!!$data['id']!!}/edit"><i
                ...
                <button type="button" class="btn btn-with-icon btn-link" data-action='DELETE' data-load-to="#app-entry"
                    data-list="#item-list" data-url="{!!guard_url('employee/employe')!!}/{!!$data['id']!!}"><i
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-8 entry-form">
            ...
            @include('employee::employe.partials.form')

            {!!Form::close()!!}
        </div>

            @include('employee::employe.partials.aside')
        </div>
    </div>

...
<div class="app-item">
    ...
    <div class="app-info" data-action='SHOW' data-load-to="#app-entry"
        data-url="{!!guard_url('employee/employe')!!}/{!!$value['id']!!}">
        <h3>{!!@$value['title']!!}</h3>
        <div class="app-metas">
            <p>{!!@$value['details']!!}</p>
    ...
    <div class="app-actions">
        <a href="{!!guard_url('employee/employe')!!}/{!!$value['id']!!}" class="btn fas fa-pencil-alt" data-action='EDIT'
            data-load-to="#app-entry" data-url="{!!guard_url('employee/employe')!!}/{!!$value['id']!!}/edit"></a>
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuLink">
                ...
                <a class="dropdown-item" href="{!!guard_url('employee/employe')!!}/{!!$value['id']!!}" 
                                        data-action='DELETE' data-load-to="#app-entry" data-list="#item-list"
                                        data-url="{!!guard_url('employee/employe')!!}/{!!$value['id']!!}"><i class="las la-times text-danger"></i>Delete</a>
            </div>
        </div>
    </div>
</div>
